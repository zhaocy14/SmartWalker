    ...
    while True:
        ...
        if len(IR.temperature) == 768:
            ...
            #  elif current_position[5] > center_left_boundry :
                    ...
                    CD.speed = 0
                    radius = abs(40*(max_boundary-current_position[1])/(max_boundary-center_left_boundry))
                    if radius < 15 :
                       radius = 15
                    CD.radius = radius
                    ...
                    CD.speed = 0
                    radius = abs(40*(current_position[3]-min_boundary)/(center_right_boundry-min_boundary))
                    if radius < 15 :
                       radius = 15
                    CD.radius = radius
                    CD.omega = -10/CD.radius
