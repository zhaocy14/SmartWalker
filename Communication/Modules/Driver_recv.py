...
from Sensors.NUC_STM32_communication import STM32Sensors
...
class DriverRecv(object):
    ...
    def send_control(self, control = None):
        if control is not None:
            ...
            self.STM32.UpdateDriver(linearVelocity=control['speed'],angularVelocity=control['radius'],distanceToCenter=control['omega'])
